...
class StateHelper {
  public:
    ...
    static void change_state(std::shared_ptr<State> state);

    static void change_group(std::shared_ptr<State> state, bool rel_to_clone);
    ...
    static void UpdateVarInvariant(std::shared_ptr<State> state, const Eigen::VectorXd dx);
